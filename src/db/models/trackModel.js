...
// const trackModel = {
//   // Create a new track
//   async create(userId, title, genre, duration, filePath, coverArtBuffer, artist) {
//     try {
//       return await db.one(
//         `INSERT INTO "Track" 
//          ("UserID", "Title", "Genre", "Duration", "FilePath", "CoverArt", "Artist", "CreatedAt")
//          VALUES ($1, $2, $3, $4, $5, $6, $7, NOW())
//          RETURNING *`,
//         [userId, title, genre, duration, filePath, coverArtBuffer, artist]
//       );
//     } catch (error) {
//       throw new Error(`Error creating track: ${error.message}`);
//     }
